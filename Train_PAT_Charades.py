...
parser.add_argument('-rgb_root', type=str, default='/media/faegheh/T71/Charades-Dataset/Charades_v1_rgb_feats_2/')
...
def run(models, criterion, num_epochs=50):
    ...
    for epoch in range(num_epochs):
        ...
        for model, gpu, dataloader, optimizer, sched, model_file in models:
            ...
            print_second_metric("./save_logit_rgb/" + str(epoch) + ".pkl", args.annotation_file, args.num_classes)
